...
# Robot & Drone Indoor Localization (ROS 2/Python)
### High‑Precision OptiTrack‑Based Localization for Autonomous Vehicles, Mobile Robots & Drones  
**By Ibrahim Al Dabbagh**

<p align="center">
  <img src="images/AV.gif" width="640">
</p>
...
> **Abstract — Global Indoor Localization**  
> **This module** provides a global indoor localization source for robots, drones, and small autonomous systems operating within a motion-capture environment. It makes use of the **high-precision** measurements delivered by **OptiTrack**—typically accurate to a **few millimetres**—to estimate the robot’s position (x, y, z) and orientation **in real time**. Such systems are commonly used in **indoor research facilities**, **testbeds**, and **controlled laboratory environments** where GPS is unavailable but precise tracking is required.  
>
> **Frame of reference.** The output is expressed in a consistent global frame such as **ENU** (East–North–Up) or the closely related **NEU** convention. These coordinate systems provide a fixed world frame in which “east” and “north” correspond to horizontal axes and “up” to the vertical axis, yielding an intuitive and unambiguous description of motion inside the facility. By supplying **stable, high-rate** pose information with **sub-centimetre accuracy**, this module supports applications including motion control experiments, multi-robot coordination, trajectory evaluation, benchmarking of estimation systems, and general indoor navigation research.  
>
> `Accuracy: mm-level` · `Rate: real-time` · `Output: x, y, z + orientation` · `Frame: ENU/NEU`

> **Demo:**  
> *Example of the autonomous vehicle navigating the indoor model-city environment while being tracked through the motion-capture-based localization node. The global pose estimates generated by this module allow the ego-vehicle to follow the road layout and execute its movements reliably within the mapped space, and displaying live tracking of its position on map.*

<p align="center">
  <img src="images/localization.gif" width="600">
</p>
---
...
<p align="center">
  <img src="images/Localization5.png" width="620">
</p>
...
<p align="center">
  <img src="images/demo_m5.png" width="600">
</p>
...
Real‑time visualization validating pose and heading.

<p align="center">
  <img src="images/Screenshot from 2024-05-27 23-27-57.png" width="720">
</p>
