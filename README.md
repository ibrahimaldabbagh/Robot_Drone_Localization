...
>
> The output is expressed in a consistent global reference frame such as ENU (East–North–Up) or the closely related NEU convention. These coordinate systems offer a fixed world frame in which “east” and “north” correspond to horizontal axes and “up” to the vertical axis, providing an intuitive and unambiguous description of motion inside the facility. By supplying stable, high-rate pose information with sub-centimetre accuracy, this module supports a wide range of applications including motion control experiments, multi-robot coordination, trajectory evaluation, benchmarking of estimation systems, and general indoor navigation research.
